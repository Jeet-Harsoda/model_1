        ...
        <div className="container">
            <div className="row align-items-center mb-5 pb-5 border-bottom">
                ...
                <div className="col-lg-7 ps-lg-5">
                    ...
                    <Link to="/services" className="btn btn-primary px-4 py-2">View Web Hosting Plans <i className="fas fa-arrow-right ms-2"></i></Link>
                </div>
            </div>
            ...
            <div className="row align-items-center mb-5 pb-5 border-bottom flex-lg-row-reverse">
                ...
                <div className="col-lg-7 pe-lg-5">
                    ...
                    <Link to="/services" className="btn btn-primary px-4 py-2">View VPS Plans <i className="fas fa-arrow-right ms-2"></i></Link>
                </div>
            </div>
            ...
            <div className="row align-items-center">
                ...
                <div className="col-lg-7 ps-lg-5">
                    ...
                    <Link to="/services" className="btn btn-primary px-4 py-2">View Cloud Plans <i className="fas fa-arrow-right ms-2"></i></Link>
                </div>
            </div>
        </div>
    </section>
