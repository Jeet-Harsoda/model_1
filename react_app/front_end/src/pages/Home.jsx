            ...
            <div className="row justify-content-center">
                <div className="col-lg-8">
                    ...
                    <div className="d-flex justify-content-center gap-3 mb-5">
                        <Link to="/services"
                            className="btn btn-light btn-lg text-primary fw-bold px-5 py-3 rounded-pill">Get Started</Link>
                        <Link to="/services"
                            className="btn btn-outline-light btn-lg px-5 py-3 rounded-pill border-2">View Plans</Link>
                    </div>
                ...
                <div className="col-md-4">
                    <div className="card h-100 p-4 border-0 shadow-sm text-center">
                        <div className="card-body">
                            ...
                            <Link to="/services" className="btn btn-outline-primary w-100">See Plans</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-4">
                    <div className="card h-100 p-4 border-0 shadow-sm text-center"
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/services" className="btn btn-primary w-100">See Plans</Link>
                        </div>
                    </div>
                </div>
