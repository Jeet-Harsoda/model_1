                ...
                <div className="card border-0 shadow-sm">
                    <div className="card-body p-0">
                        ...
                        <div className="list-group list-group-flush">
                            ...
                            <a href="order-history.html" className="list-group-item list-group-item-action p-3 text-muted">
                                <i className="fas fa-file-invoice-dollar me-2 w-20px"></i> Order History
                            </a>
                            <a href="#" className="list-group-item list-group-item-action p-3 text-muted">
