            ...
            <div className="row g-4 align-items-center">
                <div className="col-lg-4 pricing-item" data-category="hosting">
                    <div className="pricing-card card shadow-sm h-100">
                        ...
                        <a href="/service-details.html" className="btn btn-outline-primary w-100 mb-4">Select Plan</a>
                ...
                <div className="col-lg-4 pricing-item" data-category="hosting">
                    <div className="pricing-card popular shadow-lg h-100">
                        ...
                        <a href="/service-details.html" className="btn btn-primary w-100 mb-4">Select Plan</a>
